...
[Mittwoch, 02.10.2019](#12)

[Dienstag, 22.10.2019](#13)

[Mittwoch, 23.10.2019](#14)
...
In dieser Stunde wollten wir uns mit der zufälligen Auswahl des Computers auseinandersetzten. Wir haben überlegt drei Scripts für die drei Auswahlmöglichkeiten mit den If-Befehlen und Variablen einzufügen. Dann haben wir uns an das Script für den ersten Sprite (Rock C.) gesetzt: 

![image5](https://github.com/userhg/Stundenblog/blob/master/images/C%20Choice%20falsche%201.png)
...
Heute war Gesche nicht im Unterricht, sodass ich (Hannah) alleine an dem Projekt gearbeitet habe. Ich habe mir Gedanken über die letzte Stunde gemacht und den Denkfehler in unserer Vorgehensweise gefunden. Da wir für die Auswahl des Computers unterschiedliche Sprites benutzt haben und jeweils ein Script in jedem der Sprites geschrieben haben, hat beim Start des Spiels dreimal der Computer den Befehl "pick random from 1 to 3" ausgeführt. Folglich erschien nicht nur ein Costume, sondern mehrere gleichzeitig. Die selbstgedachte Lösung habe ich gleich ausprobiert, indem ich nur ein Sprite angelegt habe. Nachdem dieses zufällig einen Zahl von 1 bis 3 auswählt wird dementsprechen zu jeder Zahl das passende Costume mit "change costume to..." gewechselt. 
...
Heute ist uns aufgefallen, dass durch mehrmaliges Klicken von Space die Sprites auch wieder mitten im Spiel auftauchen. Dieses Problem haben wir durch die Flag-Methode nun behoben. Nun ist das Spiel fertig.
